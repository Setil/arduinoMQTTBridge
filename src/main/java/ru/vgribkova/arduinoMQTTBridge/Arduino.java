...
/*
  Initial Source https://github.com/HirdayGupta/Java-Arduino-Communication-Library
 */
...
public class Arduino {
	...
	public boolean openConnection(){
		if(comPort.openPort()){
			...
			logger.error(String.format("Error connecting to port [%s]. Try another one", getSerialPort()));
			return false;
		}
	}
